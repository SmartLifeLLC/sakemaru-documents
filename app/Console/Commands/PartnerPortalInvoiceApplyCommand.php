...
class PartnerPortalInvoiceApplyCommand extends Command
{
    protected $signature = 'sync:partner-portal:apply-invoices {--client_id=} {--limit=1000} {--from_start}';

    protected $description = 'Apply buyer_invoices sync to invoice DB for a limited client.';

    public function handle(PartnerPortalInvoiceApplyService $service): int
    {
        ...
        $this->info('Partner portal invoice apply completed.');
        $this->table(
